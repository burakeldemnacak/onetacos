...
function ngPlusminus() {
    return {
        restrict: 'E',
        template: `
            <div class="row" style="border: 1px solid #11723b; border-radius: 5px; text-align: center;">
                ...
                <div class="wrapper" style="height: 30px; margin: 5px 0;">
                    ...
                    <span class="btn radius-3" style="color: #000; background-color: floralwhite; height: 30px; border-color: #11723b; border-left-color: #11723b !important; margin-bottom: 6px;">+{{:: editorValue.Price.Price| number:2}} {{:: 'main.CURRENCY_SYMBOL' | translate}}</span>
                </div>
            </div>`,
        replace: true,
        require: 'ngModel',
            ...
            var result =
                ...
                `<div ng-if="option.OptionType==6">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 6px;">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12" style="border: 1px solid #11723b; border-radius: 5px;">
    ...
    var directive = {
        ...
        template: `
            ...
            <div class="col-lg-2 col-md-3 col-sm-8 col-xs-12 margin-top-5" ng-if="user.UserRole.MemberID != 106851154380">
                <div class="row" style="text-align: center; border: 1px solid #11723b; border-radius: 5px; white-space: nowrap; overflow: hidden; text-overflow: clip; padding: 3px;">
                    ...
                    <div class="row">
                        <div class="wrapper">
                            <button class="btn btn-dark-green ti-zoom-in radius-3 col-lg-3 col-md-6 col-sm-3 col-xs-3" style="height: 30px;" option-click></button>
                            ...
                            <button class="btn radius-3 col-lg-6 col-md-12 col-sm-6 col-xs-6" style="color: #000; background-color: floralwhite; height: 30px; border-color: #11723b; border-left-color: #11723b !important;">{{item.Price.Price| number : 2}} {{:: 'main.CURRENCY_SYMBOL' | translate}}</button>
                        </div>
                    </div>
                </div>
            </div>
