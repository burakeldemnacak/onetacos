...
function trendsperiodiccostsCtrl($scope, Restangular, toaster, $interval, $http, NG_SETTING, $q, $rootScope, $location, $translate, $timeout, $element, userService) {
        ...
        columns: [
            ...
            },
            {
                ...
                columns: [
                    ...
                    { dataField: "İdeal", caption: "İdeal", name: "İdeal", format: { type: "fixedPoint", precision: 0 } , visible: true  },
                    { dataField: "Costs", caption: "Costs", format: { type: "fixedPoint", precision: 0 } , visible: true },
                ]
            },
            {
                ...
                columns: [
                    ...
                    { dataField: "İdeal", caption: "İdeal", format: { type: "fixedPoint", precision: 0 } , visible: true },
                    { dataField: "Costs", caption: "Costs", format: { type: "fixedPoint", precision: 0 } , visible: true },
                ]
            },
            {
